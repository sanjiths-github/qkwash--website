...
const HubList = () => {
  ...
  return (
    ...
    <div className="box-Hub">
    <div className="circle-Hub1">
    <img src="https://cdn-icons-png.flaticon.com/512/125/125652.png" alt="Circle Icon" className="circle-image" />
    </div>
    <div className='Name2'>Machine Name</div>
    <div className='sub-Name2'>Washer 02</div>

    <button className="button-Hub2" onClick={handleButtonClick1}>Available at 10:15</button>
    ...
    {isPopupVisible2 && (
      <div className="popup-overlay">
        <div className="popup">
          ...
          <div className="popup-header">
          <div className="popup-left">
            <h2 className="title">Washer 02</h2>
            <div className="machine-info">
              <p className="label">Machine ID</p>
              <p className="subtext">#12345</p>
            </div>
    ...
    <div className="box-Hub">
    <div className="circle-Hub2">
    <img src="https://cdn-icons-png.flaticon.com/512/125/125652.png" alt="Circle Icon" className="circle-image" />
    </div>
    <div className='Name3'>Machine Name</div>
    <div className='sub-Name3'>Washer 03</div>

    <button className="button-Hub3">Under Maintenance</button>
    ...
    <div className="box-Hub">
    <div className="circle-Hub3">
    <img src="https://cdn-icons-png.flaticon.com/512/125/125652.png" alt="Circle Icon" className="circle-image" />
    </div>
    <div className='Name4'>Machine Name</div>
    <div className='sub-Name4'>Washer 04</div>
    
    <button className="button-Hub4">Available</button>
